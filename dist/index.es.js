...
var modalReducer = function modalReducer() {
  ...
  var open = action.type.includes('OPEN') || action.type.includes('TOGGLE') && !state[name].open;
...
var TOGGLE = 'REDUX_MODAL/TOGGLE';
var OPEN = 'REDUX_MODAL/OPEN';
var CLOSE = 'REDUX_MODAL/CLOSE';
...
var factoryWithTypeCheckers = function factoryWithTypeCheckers(isValidElement, throwOnDirectAccess) {
  ...
  function isNode(propValue) {
    switch (typeof propValue === 'undefined' ? 'undefined' : _typeof$2(propValue)) {
      case 'number':
      case 'string':
      case 'undefined':
        return true;
  ...
  function getPropType(propValue) {
    var propType = typeof propValue === 'undefined' ? 'undefined' : _typeof$2(propValue);
    if (Array.isArray(propValue)) {
      return 'array';
    }
...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    invariant_1$3(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + ('connect. Instead received ' + JSON.stringify(WrappedComponent)));
    ...
    var Connect = function (_Component) {
      ...
      function Connect(props, context) {
        ...
        invariant_1$3(_this.store, 'Could not find "' + storeKey + '" in either the context or props of ' + ('"' + displayName + '". Either wrap the root component in a <Provider>, ') + ('or explicitly pass "' + storeKey + '" as a prop to "' + displayName + '".'));
      ...
      Connect.prototype.getWrappedInstance = function getWrappedInstance() {
        invariant_1$3(withRef, 'To access the wrapped instance, you need to specify ' + ('{ withRef: true } in the options argument of the ' + methodName + '() call.'));
...
function shallowEqual(objA, objB) {
  ...
  if ((typeof objA === 'undefined' ? 'undefined' : _typeof$6(objA)) !== 'object' || objA === null || (typeof objB === 'undefined' ? 'undefined' : _typeof$6(objB)) !== 'object' || objB === null) {
    return false;
  }
...
var freeGlobal = (typeof global === 'undefined' ? 'undefined' : _typeof$10(global)) == 'object' && global && global.Object === Object && global;
...
var freeSelf = (typeof self === 'undefined' ? 'undefined' : _typeof$9(self)) == 'object' && self && self.Object === Object && self;
...
function isObjectLike(value) {
  return value != null && (typeof value === 'undefined' ? 'undefined' : _typeof$11(value)) == 'object';
}
...
function bindActionCreators(actionCreators, dispatch) {
  ...
  if ((typeof actionCreators === 'undefined' ? 'undefined' : _typeof$12(actionCreators)) !== 'object' || actionCreators === null) {
    throw new Error('bindActionCreators expected an object or a function, instead received ' + (actionCreators === null ? 'null' : typeof actionCreators === 'undefined' ? 'undefined' : _typeof$12(actionCreators)) + '. ' + 'Did you write "import ActionCreators from" instead of "import * as ActionCreators from"?');
  }
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && (typeof mapDispatchToProps === 'undefined' ? 'undefined' : _typeof$7(mapDispatchToProps)) === 'object' ? wrapMapToPropsConstant(function (dispatch) {
...
function match(arg, factories, name) {
  ...
  return function (dispatch, options) {
    throw new Error('Invalid value of type ' + (typeof arg === 'undefined' ? 'undefined' : _typeof$5(arg)) + ' for ' + name + ' argument when connecting component ' + options.wrappedComponentName + '.');
  };
}
...
var ModalManagerClass = function ModalManagerClass() {
  var modals = {};
  ...
  return {
    register: function register(_ref) {
      var _ref$name = _ref.name,
          ...
          _ref$gate = _ref.gate,
          gate = _ref$gate === undefined ? 'root' : _ref$gate,
          _ref$component = _ref.component,
          component = _ref$component === undefined ? function () {
        return null;
      } : _ref$component;
    ...
    getModalByName: function getModalByName(name) {
...
var ModalManager = ModalManagerClass();
...
var isModalOpenSelector = function isModalOpenSelector(name) {
...
var portalSelector = function portalSelector() {
  return function (state) {
    if (!state.modals) {
      warning$4('You need to register portal modal reducer to root reducer');
      return {};
    }
...
var connectModal = function connectModal(name) {
  var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var gate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'root';

  return function (Component$$1) {
    var HOC = connect(function (state) {
      return {
    ...
    ModalManager.register({
      ...
      gate: gate,
      props: props,
      component: HOC(Component$$1)
    });
    return HOC(Component$$1);
  };
};

var Portal = function Portal(props) {
  var modals = props.modals,
      _props$wrapComponent = props.wrapComponent,
      wrapComponent = _props$wrapComponent === undefined ? 'div' : _props$wrapComponent;

  var modalComponents = Object.keys(modals).map(function (name) {
    var modal = ModalManager.getModalByName(name);
    return modal;
  }).filter(function (t) {
    return t;
  ...
  return React.createElement(wrapComponent, {}, modalComponents.map(function (_ref) {
    var name = _ref.name,
...
var ModalPortal = connect(function (state, _ref2) {
  var _ref2$gate = _ref2.gate,
      gate = _ref2$gate === undefined ? 'root' : _ref2$gate;
...
var reducer = modalReducer$1;

export { reducer, close, open, toggle, connectModal, ModalManager, ModalManagerClass, ModalPortal, isModalOpenSelector, portalSelector };
